...
const FAQSection = () => {
  ...
  const faqs = [
    {
      question: "What is Dogecoin20?",
      answer: "Dogecoin20 is a next-generation meme coin that combines the fun of doge with real utility including staking rewards, deflationary tokenomics, and a strong community focus."
    },
    {
    ...
    {
      question: "What makes Dogecoin20 different?",
    ...
    {
      question: "How do I buy Dogecoin20?",
    ...
    },
    {
      ...
      answer: "Total supply is 140B tokens with 25% for staking rewards, 20% for liquidity, 15% for marketing, 10% for team, and 30% for presale. 2% of all transactions are burned."
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Got questions? We've got answers! Learn everything you need to know about Dogecoin20.
          </p>
        </div>
